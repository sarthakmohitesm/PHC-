...
export const INITIAL_TEAMS: Team[] = [
  {
    ...
    members: [
      ...
      { id: 'divesh-mem-18', name: 'Srushti Vidyanund Olah', role: 'Squad Member', specialtyEvent: 'Quiz', department: 'Not specified', year: 'Not specified' },
  ...
  },
  {
    ...
    members: [
      ...
      { id: 'himanshi-mem-15', name: 'Himanshi Dodiya', role: 'Captain', specialtyEvent: 'Relay', department: 'IT', year: 'TE' },
      ...
      { id: 'himanshi-mem-21', name: 'Rashi Ghadgare', role: 'Squad Member', specialtyEvent: 'Shotput', department: 'Not specified', year: 'Not specified' },
      { id: 'himanshi-mem-22', name: 'Karan Bhoir', role: 'Squad Member', specialtyEvent: 'Shotput', department: 'Not specified', year: 'Not specified' },
      { id: 'himanshi-mem-23', name: 'Sumedh Kalamalakar', role: 'Squad Member', specialtyEvent: 'Chess', department: 'Not specified', year: 'Not specified' }
    ],
    eventScores: {}
  },
  {
    ...
    members: [
      ...
      { id: 'himanshu-mem-16', name: 'Mihal Shrirkinde', role: 'Squad Member', specialtyEvent: 'Quiz', department: 'Not specified', year: 'Not specified' },
  ...
  },
  {
    ...
    members: [
      ...
      { id: 'mayur-mem-2', name: 'Jay Bandhandkar', role: 'Squad Member', specialtyEvent: 'Box Cricket', department: 'Not specified', year: 'Not specified' },
      ...
      { id: 'mayur-mem-7', name: 'Hari Om Pawse', role: 'Squad Member', specialtyEvent: 'Relay', department: 'Not specified', year: 'Not specified' },
      { id: 'mayur-mem-8', name: 'SriLaxmi V. S', role: 'Squad Member', specialtyEvent: 'Relay', department: 'Not specified', year: 'Not specified' },
      { id: 'mayur-mem-9', name: 'Gayatri Nindekar', role: 'Squad Member', specialtyEvent: 'Relay', department: 'Not specified', year: 'Not specified' },
      ...
      { id: 'mayur-mem-13', name: 'Mohit Bajkar', role: 'Squad Member', specialtyEvent: 'Badminton', department: 'Not specified', year: 'Not specified' },
      ...
      { id: 'mayur-mem-20', name: 'Vardagauni Mokal', role: 'Squad Member', specialtyEvent: 'Quiz', department: 'Not specified', year: 'Not specified' },
  ...
  },
  {
    ...
    members: [
      ...
      { id: 'saloni-mem-6', name: 'Sukhadee Palak Omkar', role: 'Squad Member', specialtyEvent: 'Quiz', department: 'Not specified', year: 'Not specified' },
      ...
      { id: 'saloni-mem-10', name: 'Anandi MD Sidique Jawed Alam', role: 'Squad Member', specialtyEvent: 'Futsal', department: 'Not specified', year: 'Not specified' },
      ...
      { id: 'saloni-mem-22', name: 'Khole Kshitij Ramesh', role: 'Squad Member', specialtyEvent: 'Relay', department: 'Not specified', year: 'Not specified' },
